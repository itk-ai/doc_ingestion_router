...
@pytest.mark.parametrize(
    ...
    [
        (
            hello_world_pdf_content,
            hello_world_pdf_tika_resp,
            "json",
            hello_world_pdf_processed_text,
        ),
        (
            hello_world_docx_content,
            hello_world_docx_tika_resp,
            "text",
            hello_world_docx_processed_text,
        ),
        (
            hello_world_doc_content,
            hello_world_doc_tika_resp,
            "text",
            hello_world_doc_processed_text,
        ),
    ],
)
async def test_process_document(
    tika_service, mocker, file_content, tika_response, tika_resp_type, expected_out
):
    ...
    text, metadata = await tika_service.process_document(file_content)
